...
class FinanceModel extends Model
{
    ...
    // get all annee
    public function getAllTypeDepenses($etablissement_code): array
    {
        $data = [];
        try {
    ...
    // get all depense
    public function getAllDepenses($etablissement_code): array
    {
        $data = [];
        try {
    ...
    public function dataTbleCountTotalDepensesRow(array $whereParams, $likeParams = [])
    {
    ...
    public function DataTableFetchDepensesListe(array $likeParams, string $orderBy, string $orderDir, int $start = 0, int $limit = 10)
    {
