...
class EtudiantModel extends Model
{
    ...
    public string $id = 'code_depense';


    // SEXION DEPENSES

    // get all annee
    public function getAllTypeEtudiant($etablissement_code): array
    {
        $data = [];
        try {
    ...
    // get all depense
    public function getAllEtudiant($etablissement_code): array
    {
        $data = [];
        try {
    ...
    public function dataTbleCountTotalEtudiantRow(array $whereParams, $likeParams = [])
    {
    ...
    public function DataTableFetchEtudiantListe(array $likeParams, string $orderBy, string $orderDir, int $start = 0, int $limit = 10)
    {
